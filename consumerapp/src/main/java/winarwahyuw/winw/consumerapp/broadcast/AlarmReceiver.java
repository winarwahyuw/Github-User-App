package winarwahyuw.winw.consumerapp.broadcast;
...
import winarwahyuw.winw.consumerapp.activity.MainActivity;
...
public class AlarmReceiver extends BroadcastReceiver {
    ...
    private void showAlarmNotification(Context context, String title, String message, int notifId) {
        ...
        //klik Notif dengan Pending Intent
    ...
    public void cancelAlarm(Context context, String type) {
        ...
        Toast.makeText(context, "Daily Remainder turned off", Toast.LENGTH_SHORT).show();
    }

    //set daily reminder
    public void setDailyRemainder(Context context, String type, String message) {
        ...
        Toast.makeText(context, "Daily Remainder turned on", Toast.LENGTH_SHORT).show();
    }
