package winarwahyuw.winw.consumerapp.database;

import android.net.Uri;
import android.provider.BaseColumns;

public class DatabaseContract {
    private static String TABLE_FAVORITE = "fav";
    //content provider
    private static final String AUTHORITY = "winarwahyuw.winw.githubuser";
